...
export interface CreditLedgerEntry {
    ...
    transaction_type: 'credit_added' | 'credit_deducted' | 'credit_expired' | 'credit_rolled_over' | 'rollover_forfeited' | 'overage_charged' | 'overage_reset' | 'auto_top_up' | 'manual_adjustment' | 'refund';

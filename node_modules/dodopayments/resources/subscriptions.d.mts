...
import * as DiscountsAPI from "./discounts.mjs";
import * as MiscAPI from "./misc.mjs";
import * as PaymentsAPI from "./payments.mjs";
import * as CreditEntitlementsAPI from "./credit-entitlements/credit-entitlements.mjs";
...
export declare class Subscriptions extends APIResource {
     ...
     * ```
     */
    updatePaymentMethod(subscriptionID: string, params: SubscriptionUpdatePaymentMethodParams, options?: RequestOptions): APIPromise<SubscriptionUpdatePaymentMethodResponse>;
    /**
     * @example
     * ```ts
     * const response =
...
export type CancellationFeedback = 'too_expensive' | 'missing_features' | 'switched_service' | 'unused' | 'customer_service' | 'low_quality' | 'too_complex' | 'other';
/**
...
export declare namespace ScheduledPlanChange {
    interface Addon {
        /**
         * The addon ID
         */
...
export declare namespace SubscriptionPreviewChangePlanResponse {
    interface ImmediateCharge {
        /**
...
export declare namespace SubscriptionRetrieveCreditUsageResponse {
    /**
...
export interface SubscriptionUpdateParams {
    ...
    cancel_reason?: 'cancelled_by_customer' | 'cancelled_by_merchant' | 'cancelled_by_merchant_send_dunning' | 'dodo_team' | null;
    /**
...
export declare namespace SubscriptionUpdateParams {
    interface CreditEntitlementCart {
        credit_entitlement_id: string;

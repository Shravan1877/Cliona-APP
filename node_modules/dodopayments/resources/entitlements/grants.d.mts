...
export declare class Grants extends APIResource {
     ...
     * ```
     */
    fulfillLicenseKey(grantID: string, body: GrantFulfillLicenseKeyParams, options?: RequestOptions): APIPromise<EntitlementGrant>;
}
...
export declare namespace Grants {
    export { type EntitlementGrant as EntitlementGrant, type LicenseKeyGrant as LicenseKeyGrant, type EntitlementGrantsDefaultPageNumberPagination as EntitlementGrantsDefaultPageNumberPagination, type GrantListParams as GrantListParams, type GrantRevokeParams as GrantRevokeParams, type GrantFulfillLicenseKeyParams as GrantFulfillLicenseKeyParams, };
}
